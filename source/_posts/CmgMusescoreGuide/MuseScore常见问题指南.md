...
![01_01_01](./img/01_01_01.png)

方法2：适合选中离散的音符/元素，按住 ctrl ，点击需要选中的音符/元素。



![01_01_02](./img/01_01_02.png)

方法3：适合选中一个区域内的音符/元素，按住 shift ，按住鼠标左键后拖动鼠标框选范围，最后松开，如图所示：

![01_01_03](./img/01_01_03.png)

最终效果如下：

![01_01_04](./img/01_01_04.png)
...
![01_02_01.png](./img/01_02_01.png)

![01_02_02](./img/01_02_02.png)

以**选中第一声部**为例：

第一步，将**全部**前的勾取消，如图所示：

![01_02_03](./img/01_02_03.png)

第二步，**勾选第一声部**，如图所示：

![01_02_04](./img/01_02_04.png)

第三步，**选中所需选区**，此时选取对象仅为第一声部的元素，最终效果如下：

![01_02_05](./img/01_02_05.png)
...
![01_03_02](./img/01_03_02.png)

第二步，**鼠标移动到任意一个音符E的符头上，点击鼠标右键**，如图所示：

![01_03_03](./img/01_03_03.png)

第三步，鼠标移动到**选择**上，在右侧菜单中选择**更多..**.，此时会弹出**选择音符**面板，如图所示：

![01_03_04](./img/01_03_04.png)

![01_03_05](./img/01_03_05.png)

第四步，勾选**同一音名和选中前的复选框**，如图所示：

![01_03_06](./img/01_03_06.png)

第五步，**点击OK**，可以看到这两个小节内的所有音符 E 都被选中了，如图所示：

![01_03_07](./img/01_03_07.png)

第六步，**按下方向键↓**，此时所有音符 E 就变为了 Eb ，最终效果如下：

![01_03_08](./img/01_03_08.png)
...
![03_01_01](./img/03_01_01.png)

----

**选中该音符（建议点击符头）**，**按下 x 键**即可，或者在上方工具栏中**点击翻转方向按钮**，两种方法等价。

![03_01_02](./img/03_01_02.png)

最终效果如下：

![03_01_03](./img/03_01_03.png)
...
![05_01_01](./img/05_01_01.png)

---

第一步，先**选中两个音符之间的休止符**，如图所示：

![05_01_02](./img/05_01_02.png)

第二步，点击左侧**符号面板-符杠属性-连续符杠**，最终效果如下：

![05_01_03](./img/05_01_03.png)
...
![06_01_01](./img/06_01_01.png)

与让音符符杠相连类似，第一步同样是**选中需要断开处后方的音符**，如图所示：

![06_01_02](./img/06_01_02.png)

第二步，点击左侧**符号面板-符杠属性-首末端符杠**，如图所示：

![06_01_03](./img/06_01_03.png)

最终效果如下：

![06_01_04](./img/06_01_04.png)
...
![07_01_02](./img/07_01_02.png)

此时输入区域会变为绿色，如图所示：

![07_01_03](./img/07_01_03.png)

第二步，**正常完成输入**，如图所示：

![07_01_04](./img/07_01_04.png)

第三步，**点击谱面空白处**，取消焦点，如图所示：

![07_01_05](./img/07_01_05.png)

第四步，输入上面的八分音符前，需要切换回第一声部。**按 ctrl + alt + 1，或是在上方工具栏右侧点击按钮'1'**，如图所示：

![07_01_06](./img/07_01_06.png)

此时输入区域会变回蓝色，如图所示：

![07_01_07](./img/07_01_07.png)

第五步，正常完成输入，最终效果如下：

![07_01_08](./img/07_01_08.png)
...
![07_01_09](./img/07_01_09.png)

---

### <span id="合并音符">八、我想让这两个音符合起来，怎么做？</span>

![08_01_01](./img/08_01_01.png)

----

**选中其中一个音符的符头将其隐藏**即可，最终效果如下：

![08_01_02](./img/08_01_02.png)
...
![08_01_03](./img/08_01_03.png)

将两个声部分离更为直观，第一声部：

![08_01_04](./img/08_01_04.png)

第二声部：

![08_01_05](./img/08_01_05.png)
...
![09_01_02](./img/09_01_02.png)

之后就可以任意安排元素的位置了，最终效果如下：

![09_01_03](./img/09_01_03.png)
...
![12_01_01](./img/12_01_01.png)

实际打出来却是这样：

![12_01_02](./img/12_01_02.png)
...
![12_01_03](./img/12_01_03.png)

第一步：选中该小节，按顺序分别**按下 n 键**（进入输入模式）、**数字键 5**（时值为四分音符）、**数字键 0**（创建休止符），使全休止符分离出四分休止符（也可通过鼠标点击图形界面实现），如图所示：

![12_01_04](./img/12_01_04.png)

第二步：**按下n键**退出输入模式（也可通过鼠标点击图形界面实现），如图所示：

![12_01_05](./img/12_01_05.png)

第三步：**选中前两个四分休止符**，如图所示：

![12_01_06](./img/12_01_06.png)

第四步：**按下ctrl + 3**创建三连音，如图所示：

![12_01_07](./img/12_01_07.png)

第五步：**正常键入所需音符**，最终效果如下：

![12_01_08](./img/12_01_08.png)
...
![13_01_02](./img/13_01_02.png)

![13_01_03](./img/13_01_03.png)

第二步，**将实际长度一栏中的值修改为 1 / 8**，即实际时值为 1 个 8 分音符，如图所示：

![13_01_04](./img/13_01_04.png)

第三步，**点击OK**，如图所示：

![13_01_05](./img/13_01_05.png)

第四步，**正常输入音符**，最终效果如下：

![13_01_06](./img/13_01_06.png)
...
![14_01_02](./img/14_01_02.png)

![14_01_03](./img/14_01_03.png)

第二步，该小节中有一个二分音符、两个四分音符和十二个十六分音符，总时值为 2+2+3=7 个四分音符，因此**将实际长度一栏改为 7 / 4** ，如图所示：

![14_01_04](./img/14_01_04.png)

第三步，**按下OK**，此时小节实际长度发生变化，如图所示：

![14_01_05](./img/14_01_05.png)

第四步，**正常输入音符**，最终效果如下：

![14_01_06](./img/14_01_06.png)
...
![15_01_02](./img/15_01_02.png)

![15_01_03](./img/15_01_03.png)

![15_01_04](./img/15_01_04.png)
...
![15_01_05](./img/15_01_05.png)

第二步：**选中该音符**，在**符号面板-震音**中找到所需震干并**点击**，如图所示：

![15_01_06](./img/15_01_06.png)

最终效果如下：

![15_01_07](./img/15_01_07.png)
...
![15_02_02](./img/15_02_02.png)

![15_02_03](./img/15_02_03.png)

![15_02_04](./img/15_02_04.png)

---

输入震间也非常简单，如要输入下图中的震间，方法如下：

![15_02_05](./img/15_02_05.png)

第一步，**计算震间两端音符的时值**，由震间记号的规定，**震间两端音符时值必须相等，且实际总时值应为谱面上其中一个音符所占时值**。根据图中所示，震间两端音符的时值应均为全音符的一半，即二分音符。

第二步，根据上一步计算得出的时值正常输入两个音符，如图所示：

![15_02_06](./img/15_02_06.png)

第三步：**选中第一个音符**，如图所示：

![15_02_07](./img/15_02_07.png)

第四步：，在**符号面板-震音**中找到所需震间并**点击**，如图所示：

![15_02_08](./img/15_02_08.png)

最终效果如下：

![15_02_09](./img/15_02_09.png)

---

### <span id="倚音">十六、这个音符前面的小音符是什么意思？怎么打出来？</span>

![16_01_01](./img/16_01_01.png)
...
1. 短倚音（又名碎音）
   ...
   **短倚音不占理论时值**，在演奏时**快速带过**（实际演奏时还是会占用一点主要音的时值），起到装饰作用。若短倚音可出现在主要音的前方，则被称为**前倚音**；若出现在主要音的后方，则被称为**后倚音**（相对于前倚音，后倚音较为少见）。单个的短倚音（单倚音）用**较小的八分音符表示，且在符干上加一斜杠**，表示不占理论时值，多个短倚音（复倚音）用**较小的十六分音符表示**。下面是一些短倚音的例子，**左为谱面记号，右为实际奏法**：
   ...
   ![16_01_02](./img/16_01_02.png)

   前复倚音：

   ![16_01_03](./img/16_01_03.png)

   后单倚音：

   ![16_01_04](./img/16_01_04.png)
...
2. 长倚音
   ...
   ![16_01_05](./img/16_01_05.png)

   ![16_01_06](./img/16_01_06.png)
...
![17_01_02](./img/17_01_02.png)

![17_01_03](./img/17_01_03.png)

![17_01_04](./img/17_01_04.png)

![17_01_05](./img/17_01_05.png)
...
![17_01_06](./img/17_01_06.png)

第二步，**选中该音符**，**按下.键**（即句号键），或在上方工具栏中**点击附点**，如图所示：

![17_01_07](./img/17_01_07.png)

最终效果如下：

![17_01_08](./img/17_01_08.png)
...
![17_01_09](./img/17_01_09.png)

第二步，**正常输入音符**，此时会直接输入附点二分音符，最终效果如下：

![17_01_10](./img/17_01_10.png)
...
![17_01_11](./img/17_01_11.png)

第二步，**在下拉菜单中选择高级**，如图所示：

![17_01_12](./img/17_01_12.png)

此时工具栏出现了复附点音符及多重附点音符等新按钮，如图所示：

![17_01_13](./img/17_01_13.png)
